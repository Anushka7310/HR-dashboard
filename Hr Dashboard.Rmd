...
americans <- read_excel("HR Dashboard_v1 - Americas.xlsx")

apac=read_excel("HR Dashboard_v1 - APAC.xlsx")

europe=read_excel("HR Dashboard_v1 - Europe.xlsx")


#Consolidating global data 
global=rbind (americans,apac,europe)
